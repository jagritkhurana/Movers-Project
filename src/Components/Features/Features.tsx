...
function Features() {
  ...
  scale:0.95
    ...
    vissible:{transition:{staggerChildren:0.1,delayChildren:0.1 }}
  }

 
  return (
    <>
      <div className='w-auto  h-auto mt-10 bg-gray-200 rounded-[98px]'>
        <div className='flex gap-10'>
          <div className=' flex flex-col gap-0 m-15 px-[135px] justify-center items-center'>
            <h1 className=' md:text-[45px] font-semibold tracking-wider'>Key Features</h1>
            <img src="/Br.svg" className='ml-[120px]'/>
          </div>
          <div className='flex justify-center items-center text-[22px] opacity-80'>
