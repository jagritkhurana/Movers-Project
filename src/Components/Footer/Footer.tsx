...
function Footer() {
  return (
    <>
      <div className=' w-screen h-auto md:h-[323px] rounded-tl-[86px] relative rounded-tr-[86px] bg-[#F2F5FF] md:flex justify-center items-center md:justify-start md:items-start md:gap-15'>
        <div className=' flex justify-center items-center  md:m-10 md:ml-[130px]'>
         ...
         <div className='flex flex-col mt-[-15px] ml-[100px] md:gap-2 md:mt-[80px] md:ml-[20px]'>
          ...
          <a href="#Features" className='text-[15px] md:text-[20px] md:tracking-wider md:mt-5 font-semibold  text-blue-500 opacity-80'>Features</a>
          <a href="#Works" className=' text-[15px] md:text-[20px] md:tracking-wider font-semibold text-blue-500 opacity-80'>How it Works</a>
        </div>
        <div className='flex flex-col mt-[-70px] ml-[225px] md:gap-2 md:mt-[80px] md:ml-[20px]'>
          ...
          <a href="#Contact" className= ' text-[15px] md:text-[20px] md:tracking-wider md:mt-5 font-semibold  text-blue-500 opacity-80'>Contact Us</a>
          <a href="#FAQ" className=' text-[15px] md:text-[20px] md:tracking-wider font-semibold text-blue-500 opacity-80'>FAQ</a>
        </div>
        <div className='flex flex-col md:gap-2 mt-[15px] ml-[100px] md:mt-[80px] md:ml-[20px]'>
          ...
          <a href="#Aboutus" className='text-[15px] md:text-[20px] md:tracking-wider md:mt-5 font-semibold  text-blue-500 opacity-80'>About Us</a>
        </div>
        ...
        <div className='relative'>
          ...
          className='absolute w-[40px] h-[40px] md:w-[68px] md:h-[68px] top-[-60px] right-[10px] rounded-full md:top-[230px] md:left-[160px] bg-blue-500  opacity-80 hover:cursor-pointer '>
      ...
      <div className='w-auto h-[63px] bg-black flex justify-center items-center'>
